...
<form:form action="/bugs/saveEditBug" method="post" modelAttribute="bugDetailEdit">
    <div class="widthDiv"><spring:message code="label.idBug"/><c:out value="${bugDetailEdit.idBug}"/></div>
    <br>

    <div hidden><form:input path="idBug" cssClass="widthField"/></div>
    <br>
